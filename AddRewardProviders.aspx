    ...
    <div style ="float: right; width: 85%;">
        ...
        <div style ="background-color: white;">
            ...
            <asp:GridView ID="grdProviders" ValidationGroup="validNewProvider" AutoGenerateColumns="False" runat="server"  class="striped" style="padding:40px;"
                         OnRowCancelingEdit="grdProviders_RowCancelingEdit" OnRowUpdating="grdProviders_RowUpdating" DataKeyNames="ProviderID" ShowHeaderWhenEmpty="True" OnRowDeleting="grdProviders_RowDeleting" AutoGenerateDeleteButton="True" >
                        <Columns>                            
